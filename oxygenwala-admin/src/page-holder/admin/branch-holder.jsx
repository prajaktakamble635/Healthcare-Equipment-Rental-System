...
const Add = React.lazy(() => import("../../page-sections/admin/branch/add.jsx"));
const Edit = React.lazy(() => import("../../page-sections/admin/branch/edit.jsx"));
const View = React.lazy(() => import("../../page-sections/admin/branch/view.jsx"));

export default function BranchHolder() {
  ...
  useEffect(() => {
    document.title = "AD Health Care | Branch Master";
  ...
  const getTableRecordByPage = (
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/adminApi/getTableBranch`, {
        currentPage,
        perPage,
        orderBy,
        orderDirection,
  ...
  const changeStatus = (id, value) => {
    const url = `${import.meta.env.VITE_API_URL}/api/adminApi/changeStatusBranch`;
    axios
      ...
      .then(({ status }) => {
        if (status === 200 || status === 201) {
          switch (value) {
            case 1:
              refreshTableData();
              toast.success("Branch activated successfully.", { position: "top-center" });
              break;
            case 2:
              refreshTableData();
              toast.success("Branch deactivated successfully.", { position: "top-center" });
              break;
            default:
          }
        }
  ...
  const deleteBranch = async (id) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/api/adminApi/deleteBranch/${id}`);
      refreshTableData();
      toast.success("Branch deleted successfully");
    } catch (err) {
      toast.error("Internal Server Error: failed to delete branch");
    }
  };
                ...
                {tableData && tableData.length === 0 ? (
                  ...
                  tableData.map((rowObj, key) => (
                    <tr key={rowObj.id}>
                            ...
                            <>
                              ...
                              <Tooltip content="Delete">
                                <Typography
                                  ...
                                  onClick={() => deleteBranch(rowObj.id)}
                                >
                      ...
                      <TableCell text={rowObj?.contactDetails || "--"} />
