...
export default function QuotationTrackingHolder() {
  ...
  React.useEffect(() => {
    document.title = "AD Health Care | Quotation Tracking";
    if (id) {
  ...
  const getTableRecordByPage = (
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/adminApi/getTableQuotationTracking`, {
        id: id,
        currentPage,
        perPage,
        orderBy,
      ...
      .catch((errors) => {
        ...
        switch (errors.response.status) {
          case 401:
            ...
            break;
          default:
          // For other errors, we stay on the current page to show the error
          // But if we needed to redirect on error (like 403), we'd use:
        ...
        >
          <div className="flex flex-col justify-between md:flex-row">
            <Typography variant="h6" color="white">
              Quotation Tracking (# {quotationNo})
            </Typography>
