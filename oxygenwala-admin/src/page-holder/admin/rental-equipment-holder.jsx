...
export default function RentalEquipmentHolder() {
  ...
  useEffect(() => {
    document.title = "AD Health Care | Rental Equipment Master";
  ...
  const getTableRecordByPage = (
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/adminApi/getRentalEquipmentTableData`, {
        currentPage,
        perPage,
        orderBy,
        orderDirection,
          ...
          <div className="flex flex-col justify-between md:flex-row items-center gap-4">
            ...
            <div className="flex flex-col gap-2 md:flex-row w-full md:w-auto">
              ...
              <div className="flex flex-row gap-2 self-end">
                {/* ADD button removed as it is for regular equipment master */}
                <Button
                  onClick={(event) => {
