...
export default function AddMaintenance(props) {
  ...
  const submitData = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/adminApi/addMaintenanceRecord`, formData, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token") || ""}` }
      });
      toast.success("Maintenance record created successfully.", { position: "top-center", theme });
