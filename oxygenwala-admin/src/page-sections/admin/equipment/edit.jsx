...
export default function Edit(props) {
  ...
  useEffect(() => {
    if (props.obj) {
      setFormData({
        id: props.obj.id,
        equipmentCategoryIdFk: props.obj.equipmentCategoryIdFk || "",
        branchIdFk: props.obj.branchIdFk || "",
        modelName: props.obj.modelName || "",
        serialNumber: props.obj.serialNumber || "",
        purchaseDate: props.obj.purchaseDate || "",
        purchaseRate: props.obj.purchaseRate || "",
        warrantyPeriod: props.obj.warrantyPeriod || "",
        images: props.obj.images || [],
        warrantyDetails: props.obj.warrantyDetails || "",
        rentalRateDaily: props.obj.rentalRateDaily || 0,
        rentalRateWeekly: props.obj.rentalRateWeekly || 0,
        rentalRateMonthly: props.obj.rentalRateMonthly || 0,
        sellingPrice: props.obj.sellingPrice || 0,
        dealerRentalRateDaily: props.obj.dealerRentalRateDaily || 0,
        dealerRentalRateWeekly: props.obj.dealerRentalRateWeekly || 0,
        dealerRentalRateMonthly: props.obj.dealerRentalRateMonthly || 0,
        dealerSellingPrice: props.obj.dealerSellingPrice || 0,
        maintenanceSchedule: props.obj.maintenanceSchedule || "",
        gst: props.obj.gst || "",
  ...
  const submitData = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/adminApi/updateEquipment`, formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token") || ""}`
        }
      });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-2">
            ...
            <div className="md:col-span-2 border rounded-md p-4 bg-gray-50">
              ...
              <div className="flex gap-2">
                <input
                  type="file"
                  id="equipment-images-upload-edit"
                  multiple
                  accept="image/*"
                  className="hidden"
                  onChange={uploadFile}
                ...
                />
                <label
                  htmlFor="equipment-images-upload-edit"
